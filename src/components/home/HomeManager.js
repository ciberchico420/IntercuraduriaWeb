...
function HomeManager(props) {
    return (<div className="">
       ...
       <ButtonCircle className="nosotrasButton" empty={false} section="nosotras" buttonText="NOSOTRAS" size={10} top={10} left={80}><PageFromCategory category="2"></PageFromCategory></ButtonCircle>
